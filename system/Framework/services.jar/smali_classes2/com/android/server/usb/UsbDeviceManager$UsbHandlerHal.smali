...
.method constructor <init>(Landroid/os/Looper;Landroid/content/Context;Lcom/android/server/usb/UsbDeviceManager;Lcom/android/server/usb/UsbAlsaManager;Lcom/android/server/usb/UsbPermissionManager;)V
    ...
    monitor-enter v3
    :try_end_2d
    .catch Ljava/util/NoSuchElementException; {:try_start_d .. :try_end_2d} :catch_7c
    .catch Landroid/os/RemoteException; {:try_start_d .. :try_end_2d} :catch_71
    .catch Ljava/lang/Exception; {:try_start_d .. :try_end_2d} :catch_66
    ...
    monitor-exit v3
    :try_end_4f
    .catchall {:try_start_2e .. :try_end_4f} :catchall_63
    ...
    :try_end_62
    .catch Ljava/util/NoSuchElementException; {:try_start_4f .. :try_end_62} :catch_7c
    .catch Landroid/os/RemoteException; {:try_start_4f .. :try_end_62} :catch_71
    .catch Ljava/lang/Exception; {:try_start_4f .. :try_end_62} :catch_66
    ...
    throw v0
    :try_end_66
    .catch Ljava/util/NoSuchElementException; {:try_start_65 .. :try_end_66} :catch_7c
    .catch Landroid/os/RemoteException; {:try_start_65 .. :try_end_66} :catch_71
...
.method private setUsbConfig(JZ)V
    ...
    invoke-static {v1, v3, v0}, Landroid/util/sysfwutil/Slog;->e(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    const-string/jumbo v2, "reset Usb Gadget mGadgetProxy is null"
    ...
    monitor-exit v0
    :try_end_1e
    .catchall {:try_start_f .. :try_end_1e} :catchall_38
    ...
    :try_end_60
    .catch Ljava/util/NoSuchElementException; {:try_start_45 .. :try_end_60} :catch_6e
    .catch Landroid/os/RemoteException; {:try_start_45 .. :try_end_60} :catch_63
    .catchall {:try_start_45 .. :try_end_60} :catchall_61
    ...
    invoke-static {v2, v4, v1}, Landroid/util/sysfwutil/Slog;->e(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I
    ...
    const-string/jumbo v3, "prcessing MSG_GET_CURRENT_USB_FUNCTIONS"
    ...
    const-string/jumbo v4, "mCurrentFunctions:"
