...
.method constructor <init>(Landroid/content/Context;)V
    ...
    monitor-exit v0
    :try_end_bb
    .catchall {:try_start_6b .. :try_end_bb} :catchall_159
    ...
    :try_end_110
    .catch Landroid/content/IntentFilter$MalformedMimeTypeException; {:try_start_10b .. :try_end_110} :catch_111
...
.method private destroyCeSnapshotsForExpiredRollbacks(I)V
    ...
    :try_end_2b
    .catch Lcom/android/server/pm/Installer$InstallerException; {:try_start_26 .. :try_end_2b} :catch_2c
...
.method private enableRollback(I)Z
    ...
    monitor-exit v4
    :try_end_72
    .catchall {:try_start_51 .. :try_end_72} :catchall_aa
    ...
    monitor-exit v2
    :try_end_9f
    .catchall {:try_start_8f .. :try_end_9f} :catchall_a4
...
.method private enableRollbackForPackageSession(Lcom/android/server/rollback/Rollback;Landroid/content/pm/PackageInstaller$SessionInfo;)Z
    ...
    move-result-object v0
    :try_end_bd
    .catch Landroid/content/pm/PackageManager$NameNotFoundException; {:try_start_b9 .. :try_end_bd} :catch_14b
    ...
    :try_end_e2
    .catch Landroid/content/pm/PackageManager$NameNotFoundException; {:try_start_de .. :try_end_e2} :catch_100
...
.method private getInstalledPackageVersion(Ljava/lang/String;)J
    ...
    move-result-object v0
    :try_end_4
    .catch Landroid/content/pm/PackageManager$NameNotFoundException; {:try_start_0 .. :try_end_4} :catch_a
...
.method private runExpiration()V
    ...
    monitor-exit v2
    :try_end_6b
    .catchall {:try_start_11 .. :try_end_6b} :catchall_83
...
.method public synthetic lambda$notifyStagedApkSession$9$RollbackManagerServiceImpl(II)V
    ...
    const-string/jumbo v4, "notifyStagedApkSession did not find rollback for session "
    ...
    monitor-exit v1
    :try_end_47
    .catchall {:try_start_5 .. :try_end_47} :catchall_4d
...
.method public synthetic lambda$notifyStagedSession$8$RollbackManagerServiceImpl(ILjava/util/concurrent/LinkedBlockingQueue;)V
    ...
    monitor-exit v3
    :try_end_37
    .catchall {:try_start_32 .. :try_end_37} :catchall_ba
...
.method public synthetic lambda$onBootCompleted$6$RollbackManagerServiceImpl()V
    ...
    monitor-exit v3
    :try_end_78
    .catchall {:try_start_18 .. :try_end_78} :catchall_c7
    ...
    monitor-exit v4
    :try_end_be
    .catchall {:try_start_b8 .. :try_end_be} :catchall_c4
...
.method onUnlockUser(I)V
    ...
    :try_end_30
    .catch Ljava/lang/InterruptedException; {:try_start_2d .. :try_end_30} :catch_32
...
.method public reloadPersistedData()V
    ...
    invoke-virtual {v0}, Ljava/util/concurrent/CountDownLatch;->await()V
    :try_end_1f
    .catch Ljava/lang/InterruptedException; {:try_start_1c .. :try_end_1f} :catch_21
