...
.method private bind(Ljava/lang/String;)Landroid/app/IInstantAppResolver;
    ...
    :try_end_30
    .catchall {:try_start_4 .. :try_end_30} :catchall_139
    ...
    .catchall {:try_start_30 .. :try_end_39} :catchall_139
    ...
    monitor-exit v1
    :try_end_76
    .catchall {:try_start_39 .. :try_end_76} :catchall_139
...
.method public getInstantAppIntentFilterList(Landroid/content/pm/InstantAppRequestInfo;Lcom/android/server/pm/InstantAppResolverConnection$PhaseTwoCallback;Landroid/os/Handler;J)V
    ...
    :try_end_15
    .catch Ljava/util/concurrent/TimeoutException; {:try_start_a .. :try_end_15} :catch_20
...
.method public getInstantAppResolveInfoList(Landroid/content/pm/InstantAppRequestInfo;)Ljava/util/List;
    ...
    move-result-object v1
    :try_end_c
    .catch Ljava/util/concurrent/TimeoutException; {:try_start_4 .. :try_end_c} :catch_43
    .catch Ljava/lang/InterruptedException; {:try_start_4 .. :try_end_c} :catch_3b
    ...
    move-result-object v1
    :try_end_14
    .catch Ljava/util/concurrent/TimeoutException; {:try_start_e .. :try_end_14} :catch_31
    .catch Landroid/os/RemoteException; {:try_start_e .. :try_end_14} :catch_21
    .catchall {:try_start_e .. :try_end_14} :catchall_39
    ...
    throw v2
    :try_end_4b
    .catchall {:try_start_32 .. :try_end_4b} :catchall_39
