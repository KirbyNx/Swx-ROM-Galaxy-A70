...
.method private handleMessageInner(Landroid/os/Message;)Z
    ...
    const-string/jumbo v7, "top state loss for "
    ...
    # getter for: Lcom/android/server/wm/ActivityStackSupervisor;->mHandler:Lcom/android/server/wm/ActivityStackSupervisor$ActivityStackSupervisorHandler;
    ...
    const-string/jumbo v1, "homeChanged"
    ...
    # getter for: Lcom/android/server/wm/ActivityStackSupervisor;->mPipModeChangedActivities:Ljava/util/ArrayList;
    ...
    # getter for: Lcom/android/server/wm/ActivityStackSupervisor;->mPipModeChangedTargetStackBounds:Landroid/graphics/Rect;
    ...
    # getter for: Lcom/android/server/wm/ActivityStackSupervisor;->mMultiWindowModeChangedActivities:Ljava/util/ArrayList;
    ...
    # invokes: Lcom/android/server/wm/ActivityStackSupervisor;->processStoppingAndFinishingActivities(Lcom/android/server/wm/ActivityRecord;ZLjava/lang/String;)V
    ...
    const-string/jumbo v4, "handleMessage: IDLE_NOW_MSG: r="
    ...
    # invokes: Lcom/android/server/wm/ActivityStackSupervisor;->handleLaunchTaskBehindCompleteLocked(Lcom/android/server/wm/ActivityRecord;)V
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    monitor-exit v0
    :try_end_16
    .catchall {:try_start_15 .. :try_end_16} :catchall_62
    ...
    monitor-exit v3
    :try_end_4a
    .catchall {:try_start_2e .. :try_end_4a} :catchall_5c
    ...
    const-string/jumbo v4, "restartActivityProcessTimeout"
