...
.method private constructor <init>(IIILjava/lang/String;Ljava/lang/String;Ljava/lang/String;[Ljava/io/FileDescriptor;)V
    ...
    .param p5, "rawEvent"    # Ljava/lang/String;
    .param p6, "logMessage"    # Ljava/lang/String;
    .param p7, "fdList"    # [Ljava/io/FileDescriptor;
...
.method public static filterMessageList([Lcom/android/server/knox/ddar/nativedaemon/NativeDaemonEvent;I)[Ljava/lang/String;
    .registers 7
    .param p0, "events"    # [Lcom/android/server/knox/ddar/nativedaemon/NativeDaemonEvent;
    ...
    .line 195
    .local v3, "event":Lcom/android/server/knox/ddar/nativedaemon/NativeDaemonEvent;
    ...
    .line 194
    .end local v3    # "event":Lcom/android/server/knox/ddar/nativedaemon/NativeDaemonEvent;
    :cond_18
...
.method public static parseRawEvent(Ljava/lang/String;[Ljava/io/FileDescriptor;)Lcom/android/server/knox/ddar/nativedaemon/NativeDaemonEvent;
    ...
    .line 139
    .local v10, "parsed":[Ljava/lang/String;
    array-length v1, v10
    ...
    move-result v5
    :try_end_1a
    .catch Ljava/lang/NumberFormatException; {:try_start_e .. :try_end_1a} :catch_bd
    ...
    invoke-static {v3}, Lcom/android/server/knox/ddar/nativedaemon/NativeDaemonEvent;->isClassUnsolicited(I)Z
    ...
    const-string v12, "Insufficient arguemnts"
    ...
    move-result v2
    :try_end_4b
    .catch Ljava/lang/NumberFormatException; {:try_start_3e .. :try_end_4b} :catch_50
    ...
    new-instance v15, Lcom/android/server/knox/ddar/nativedaemon/NativeDaemonEvent;
    ...
    .end local v3    # "code":I
    .end local v11    # "skiplength":I
    .end local v12    # "cmdNumber":I
