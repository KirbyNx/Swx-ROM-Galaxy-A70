...
.method private runLookup()I
    ...
    move-result-object v0
    :try_end_45
    .catch Landroid/content/pm/PackageManager$NameNotFoundException; {:try_start_41 .. :try_end_45} :catch_134
    ...
    :try_end_4f
    .catchall {:try_start_4c .. :try_end_4f} :catchall_12a
    ...
    :try_end_94
    .catch Landroid/content/res/Resources$NotFoundException; {:try_start_4f .. :try_end_94} :catch_a1
    .catchall {:try_start_4f .. :try_end_94} :catchall_9a
    ...
    move-result-object v15
    :try_end_bb
    .catch Landroid/content/res/Resources$NotFoundException; {:try_start_a3 .. :try_end_bb} :catch_108
    .catchall {:try_start_a3 .. :try_end_bb} :catchall_12a
    ...
    invoke-virtual {v1, v0}, Ljava/io/PrintWriter;->println(Ljava/lang/String;)V
    :try_end_c6
    .catch Landroid/content/res/Resources$NotFoundException; {:try_start_bf .. :try_end_c6} :catch_c7
    .catchall {:try_start_bf .. :try_end_c6} :catchall_9a
    ...
    invoke-direct {v0}, Landroid/util/TypedValue;-><init>()V
    :try_end_d4
    .catch Landroid/content/res/Resources$NotFoundException; {:try_start_cf .. :try_end_d4} :catch_108
    .catchall {:try_start_cf .. :try_end_d4} :catchall_12a
    ...
    :try_end_f4
    .catch Landroid/content/res/Resources$NotFoundException; {:try_start_dc .. :try_end_f4} :catch_106
    .catchall {:try_start_dc .. :try_end_f4} :catchall_128
    ...
    throw v0
    :try_end_106
    .catch Landroid/content/res/Resources$NotFoundException; {:try_start_100 .. :try_end_106} :catch_106
    .catchall {:try_start_100 .. :try_end_106} :catchall_128
    ...
    :try_end_121
    .catchall {:try_start_10d .. :try_end_121} :catchall_128
...
.method public onCommand(Ljava/lang/String;)I
    ...
    move-result v1
    :try_end_88
    .catch Ljava/lang/IllegalArgumentException; {:try_start_c .. :try_end_88} :catch_9f
    .catch Landroid/os/RemoteException; {:try_start_c .. :try_end_88} :catch_89
    ...
    :sswitch_data_ba
    .sparse-switch
        -0x5120f151 -> :sswitch_4e
        -0x4d6ada7d -> :sswitch_44
        -0x41645686 -> :sswitch_39
        -0x2f5d012c -> :sswitch_2f
        0x32b09e -> :sswitch_24
