...
.method public static generateApkVeritySetupData(Ljava/lang/String;)Lcom/android/server/security/VerityUtils$SetupResult;
    ...
    .catch Ljava/lang/SecurityException; {:try_start_1 .. :try_end_b} :catch_4a
    .catch Ljava/security/DigestException; {:try_start_1 .. :try_end_b} :catch_4a
    .catch Ljava/security/NoSuchAlgorithmException; {:try_start_1 .. :try_end_b} :catch_4a
    .catch Landroid/util/apk/SignatureNotFoundException; {:try_start_1 .. :try_end_b} :catch_4a
    .catch Landroid/system/ErrnoException; {:try_start_1 .. :try_end_b} :catch_4a
    ...
    move-result-object v5
    :try_end_38
    .catch Ljava/io/IOException; {:try_start_12 .. :try_end_38} :catch_4a
    .catch Ljava/lang/SecurityException; {:try_start_12 .. :try_end_38} :catch_4a
    .catch Ljava/security/DigestException; {:try_start_12 .. :try_end_38} :catch_4a
    .catch Ljava/security/NoSuchAlgorithmException; {:try_start_12 .. :try_end_38} :catch_4a
    .catch Landroid/util/apk/SignatureNotFoundException; {:try_start_12 .. :try_end_38} :catch_4a
    .catch Landroid/system/ErrnoException; {:try_start_12 .. :try_end_38} :catch_4a
    .catchall {:try_start_12 .. :try_end_38} :catchall_48
    ...
    move-result-object v5
    :try_end_42
    .catch Ljava/io/IOException; {:try_start_3e .. :try_end_42} :catch_4a
    .catch Ljava/lang/SecurityException; {:try_start_3e .. :try_end_42} :catch_4a
    .catch Ljava/security/DigestException; {:try_start_3e .. :try_end_42} :catch_4a
    .catch Ljava/security/NoSuchAlgorithmException; {:try_start_3e .. :try_end_42} :catch_4a
    .catch Landroid/util/apk/SignatureNotFoundException; {:try_start_3e .. :try_end_42} :catch_4a
    .catch Landroid/system/ErrnoException; {:try_start_3e .. :try_end_42} :catch_4a
