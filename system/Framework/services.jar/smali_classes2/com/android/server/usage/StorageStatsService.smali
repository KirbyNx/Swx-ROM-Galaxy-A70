...
.method public queryCratesForPackage(Ljava/lang/String;Ljava/lang/String;ILjava/lang/String;)Landroid/content/pm/ParceledListSlice;
    ...
    move-result-object v0
    :try_end_1a
    .catch Landroid/content/pm/PackageManager$NameNotFoundException; {:try_start_12 .. :try_end_1a} :catch_36
...
.method public queryCratesForUid(Ljava/lang/String;ILjava/lang/String;)Landroid/content/pm/ParceledListSlice;
    ...
    :try_end_50
    .catch Landroid/content/pm/PackageManager$NameNotFoundException; {:try_start_3d .. :try_end_50} :catch_55
...
.method public queryStatsForPackage(Ljava/lang/String;Ljava/lang/String;ILjava/lang/String;)Landroid/app/usage/StorageStats;
    ...
    move-result-object v0
    :try_end_21
    .catch Landroid/content/pm/PackageManager$NameNotFoundException; {:try_start_19 .. :try_end_21} :catch_d6
    ...
    :try_end_90
    .catch Lcom/android/server/pm/Installer$InstallerException; {:try_start_8e .. :try_end_90} :catch_c2
    ...
    :try_end_a4
    .catch Lcom/android/server/pm/Installer$InstallerException; {:try_start_a1 .. :try_end_a4} :catch_be
    ...
    const-string/jumbo v3, "queryStatsForPackage"
...
.method public queryStatsForUid(Ljava/lang/String;ILjava/lang/String;)Landroid/app/usage/StorageStats;
    ...
    :try_end_74
    .catch Landroid/content/pm/PackageManager$NameNotFoundException; {:try_start_51 .. :try_end_74} :catch_79
    ...
    move-result v0
    :try_end_8c
    .catch Lcom/android/server/pm/Installer$InstallerException; {:try_start_86 .. :try_end_8c} :catch_103
    ...
    move-result v0
    :try_end_ab
    .catch Lcom/android/server/pm/Installer$InstallerException; {:try_start_a2 .. :try_end_ab} :catch_fd
    ...
    move-result-object v4
    :try_end_d4
    .catch Lcom/android/server/pm/Installer$InstallerException; {:try_start_ad .. :try_end_d4} :catch_de
    ...
    :try_end_d9
    .catch Lcom/android/server/pm/Installer$InstallerException; {:try_start_d6 .. :try_end_d9} :catch_da
    ...
    const-string/jumbo v6, "queryStatsForUid"
