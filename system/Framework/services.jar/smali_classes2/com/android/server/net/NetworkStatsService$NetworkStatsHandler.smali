...
.method public handleMessage(Landroid/os/Message;)V
    ...
    # getter for: Lcom/android/server/net/NetworkStatsService;->mLastNetworkStates:[Landroid/net/NetworkState;
    ...
    # getter for: Lcom/android/server/net/NetworkStatsService;->mDefaultNetworks:[Landroid/net/Network;
    ...
    # getter for: Lcom/android/server/net/NetworkStatsService;->mLastNetworkStates:[Landroid/net/NetworkState;
    invoke-static {v3}, Lcom/android/server/net/NetworkStatsService;->access$200(Lcom/android/server/net/NetworkStatsService;)[Landroid/net/NetworkState;

    move-result-object v3

    iget-object v4, p0, Lcom/android/server/net/NetworkStatsService$NetworkStatsHandler;->this$0:Lcom/android/server/net/NetworkStatsService;

    # getter for: Lcom/android/server/net/NetworkStatsService;->mActiveIface:Ljava/lang/String;
    invoke-static {v4}, Lcom/android/server/net/NetworkStatsService;->access$400(Lcom/android/server/net/NetworkStatsService;)Ljava/lang/String;

    move-result-object v4

    # invokes: Lcom/android/server/net/NetworkStatsService;->updateIfaces([Landroid/net/Network;[Lcom/android/internal/net/VpnInfo;[Landroid/net/NetworkState;Ljava/lang/String;)V
    invoke-static {v0, v1, v2, v3, v4}, Lcom/android/server/net/NetworkStatsService;->access$500(Lcom/android/server/net/NetworkStatsService;[Landroid/net/Network;[Lcom/android/internal/net/VpnInfo;[Landroid/net/NetworkState;Ljava/lang/String;)V
