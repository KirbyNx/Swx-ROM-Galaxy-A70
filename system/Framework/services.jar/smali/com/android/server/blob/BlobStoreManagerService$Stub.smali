...
.method public abandonSession(JLjava/lang/String;)V
    ...
    # invokes: Lcom/android/server/blob/BlobStoreManagerService;->verifyCallingPackage(ILjava/lang/String;)V
    ...
    # invokes: Lcom/android/server/blob/BlobStoreManagerService;->abandonSessionInternal(JILjava/lang/String;)V
...
.method public acquireLease(Landroid/app/blob/BlobHandle;ILjava/lang/CharSequence;JLjava/lang/String;)V
    ...
    # getter for: Lcom/android/server/blob/BlobStoreManagerService;->mPackageManagerInternal:Landroid/content/pm/PackageManagerInternal;
    ...
    # invokes: Lcom/android/server/blob/BlobStoreManagerService;->acquireLeaseInternal(Landroid/app/blob/BlobHandle;ILjava/lang/CharSequence;JILjava/lang/String;)V
    ...
    :try_end_6b
    .catch Landroid/content/res/Resources$NotFoundException; {:try_start_60 .. :try_end_6b} :catch_74
    .catch Landroid/os/LimitExceededException; {:try_start_60 .. :try_end_6b} :catch_6d
...
.method public createSession(Landroid/app/blob/BlobHandle;Ljava/lang/String;)J
    ...
    # invokes: Lcom/android/server/blob/BlobStoreManagerService;->createSessionInternal(Landroid/app/blob/BlobHandle;ILjava/lang/String;)J
    ...
    move-result-wide v1
    :try_end_33
    .catch Landroid/os/LimitExceededException; {:try_start_2d .. :try_end_33} :catch_34
...
.method public deleteBlob(J)V
    ...
    # invokes: Lcom/android/server/blob/BlobStoreManagerService;->deleteBlobInternal(JI)V
...
.method public dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    # getter for: Lcom/android/server/blob/BlobStoreManagerService;->mContext:Landroid/content/Context;
    ...
    .line 1638
    # invokes: Lcom/android/server/blob/BlobStoreManagerService$DumpArgs;->dumpArgsUsage(Lcom/android/internal/util/IndentingPrintWriter;)V
    ...
    # getter for: Lcom/android/server/blob/BlobStoreManagerService;->mBlobsLock:Ljava/lang/Object;
    ...
    # getter for: Lcom/android/server/blob/BlobStoreManagerService;->mCurrentMaxSessionId:J
    ...
    # invokes: Lcom/android/server/blob/BlobStoreManagerService;->dumpSessionsLocked(Lcom/android/internal/util/IndentingPrintWriter;Lcom/android/server/blob/BlobStoreManagerService$DumpArgs;)V
    ...
    # invokes: Lcom/android/server/blob/BlobStoreManagerService;->dumpBlobsLocked(Lcom/android/internal/util/IndentingPrintWriter;Lcom/android/server/blob/BlobStoreManagerService$DumpArgs;)V
...
.method public getLeaseInfo(Landroid/app/blob/BlobHandle;Ljava/lang/String;)Landroid/app/blob/LeaseInfo;
    ...
    # invokes: Lcom/android/server/blob/BlobStoreManagerService;->getLeaseInfoInternal(Landroid/app/blob/BlobHandle;ILjava/lang/String;)Landroid/app/blob/LeaseInfo;
...
.method public getLeasedBlobs(Ljava/lang/String;)Ljava/util/List;
    ...
    # invokes: Lcom/android/server/blob/BlobStoreManagerService;->getLeasedBlobsInternal(ILjava/lang/String;)Ljava/util/List;
...
.method public getRemainingLeaseQuotaBytes(Ljava/lang/String;)J
    ...
    # invokes: Lcom/android/server/blob/BlobStoreManagerService;->getRemainingLeaseQuotaBytesInternal(ILjava/lang/String;)J
...
.method public synthetic lambda$waitForIdle$0$BlobStoreManagerService$Stub(Landroid/os/RemoteCallback;)V
    ...
    # getter for: Lcom/android/server/blob/BlobStoreManagerService;->mHandler:Landroid/os/Handler;
...
.method public synthetic lambda$waitForIdle$1$BlobStoreManagerService$Stub(Landroid/os/RemoteCallback;)V
    ...
    # getter for: Lcom/android/server/blob/BlobStoreManagerService;->mBackgroundHandler:Landroid/os/Handler;
...
.method public openBlob(Landroid/app/blob/BlobHandle;Ljava/lang/String;)Landroid/os/ParcelFileDescriptor;
    ...
    # invokes: Lcom/android/server/blob/BlobStoreManagerService;->openBlobInternal(Landroid/app/blob/BlobHandle;ILjava/lang/String;)Landroid/os/ParcelFileDescriptor;
...
.method public openSession(JLjava/lang/String;)Landroid/app/blob/IBlobStoreSession;
    ...
    # invokes: Lcom/android/server/blob/BlobStoreManagerService;->openSessionInternal(JILjava/lang/String;)Lcom/android/server/blob/BlobStoreSession;
...
.method public queryBlobsForUser(I)Ljava/util/List;
    ...
    # invokes: Lcom/android/server/blob/BlobStoreManagerService;->queryBlobsForUserInternal(I)Ljava/util/List;
...
.method public releaseLease(Landroid/app/blob/BlobHandle;Ljava/lang/String;)V
    ...
    # invokes: Lcom/android/server/blob/BlobStoreManagerService;->releaseLeaseInternal(Landroid/app/blob/BlobHandle;ILjava/lang/String;)V
