...
.method private prunePackagesLocked(J)Ljava/util/Set;
    ...
    # invokes: Lcom/android/server/PackageWatchdog$MonitoredPackage;->getName()Ljava/lang/String;
...
.method public static read(Lorg/xmlpull/v1/XmlPullParser;Lcom/android/server/PackageWatchdog;)Lcom/android/server/PackageWatchdog$ObserverInternal;
    ...
    move-result v6
    :try_end_3e
    .catch Lorg/xmlpull/v1/XmlPullParserException; {:try_start_2d .. :try_end_3e} :catch_93
    .catch Ljava/io/IOException; {:try_start_2d .. :try_end_3e} :catch_93
    ...
    .line 1153
    .local v9, "duration":J
    const-string/jumbo v6, "health-check-duration"
    ...
    :try_end_6e
    .catch Ljava/lang/NumberFormatException; {:try_start_40 .. :try_end_6e} :catch_6f
    .catch Lorg/xmlpull/v1/XmlPullParserException; {:try_start_40 .. :try_end_6e} :catch_93
    .catch Ljava/io/IOException; {:try_start_40 .. :try_end_6e} :catch_93
    ...
    :try_end_84
    .catch Lorg/xmlpull/v1/XmlPullParserException; {:try_start_70 .. :try_end_84} :catch_93
    .catch Ljava/io/IOException; {:try_start_70 .. :try_end_84} :catch_93
...
.method public dump(Lcom/android/internal/util/IndentingPrintWriter;)V
    ...
    # getter for: Lcom/android/server/PackageWatchdog$MonitoredPackage;->mFailureHistory:Landroid/util/LongArrayQueue;
    ...
    # getter for: Lcom/android/server/PackageWatchdog$MonitoredPackage;->mDurationMs:J
    ...
    # getter for: Lcom/android/server/PackageWatchdog$MonitoredPackage;->mHealthCheckDurationMs:J
    ...
    # getter for: Lcom/android/server/PackageWatchdog$MonitoredPackage;->mHealthCheckState:I
    ...
    # invokes: Lcom/android/server/PackageWatchdog$MonitoredPackage;->toString(I)Ljava/lang/String;
...
.method public onPackageFailureLocked(Ljava/lang/String;)Z
    ...
    # getter for: Lcom/android/server/PackageWatchdog;->sPackageWatchdog:Lcom/android/server/PackageWatchdog;
...
.method public writeLocked(Lorg/xmlpull/v1/XmlSerializer;)Z
    ...
    :try_end_29
    .catch Ljava/io/IOException; {:try_start_4 .. :try_end_29} :catch_2b
