...
.method static shutdown()V
    ...
    monitor-enter v2
    :try_end_2e
    .catchall {:try_start_a .. :try_end_2e} :catchall_c7
    ...
    monitor-exit v2
    :try_end_34
    .catchall {:try_start_2e .. :try_end_34} :catchall_c4
    ...
    :try_end_3b
    .catchall {:try_start_34 .. :try_end_3b} :catchall_c7
    ...
    move-result v2
    :try_end_47
    .catch Ljava/lang/InterruptedException; {:try_start_3b .. :try_end_47} :catch_9d
    .catchall {:try_start_3b .. :try_end_47} :catchall_c7
    ...
    monitor-enter v5
    :try_end_70
    .catchall {:try_start_4a .. :try_end_70} :catchall_c7
    ...
    monitor-exit v5
    :try_end_78
    .catchall {:try_start_70 .. :try_end_78} :catchall_9a
    ...
    throw v5
    :try_end_9a
    .catchall {:try_start_78 .. :try_end_9a} :catchall_c7
    ...
    throw v3
    :try_end_c4
    .catchall {:try_start_9c .. :try_end_c4} :catchall_c7
...
.method public synthetic lambda$submitTask$0$SystemServerInitThreadPool(Ljava/lang/String;Ljava/lang/Runnable;)V
    ...
    :try_end_35
    .catch Ljava/lang/RuntimeException; {:try_start_32 .. :try_end_35} :catch_60
    ...
    monitor-exit v1
    :try_end_3f
    .catchall {:try_start_39 .. :try_end_3f} :catchall_5d
