...
.method public setupTestNetwork(Ljava/lang/String;Landroid/net/LinkProperties;Z[ILandroid/os/IBinder;)V
    ...
    monitor-enter v13
    :try_end_3b
    .catch Ljava/net/SocketException; {:try_start_30 .. :try_end_3b} :catch_68
    .catch Landroid/os/RemoteException; {:try_start_30 .. :try_end_3b} :catch_66
    ...
    throw v0
    :try_end_66
    .catch Ljava/net/SocketException; {:try_start_65 .. :try_end_66} :catch_68
...
.method public teardownTestNetwork(I)V
    ...
    .line 362
    :cond_14
    # getter for: Lcom/android/server/TestNetworkService$TestNetworkAgent;->mUid:I
    ...
    .line 367
    # invokes: Lcom/android/server/TestNetworkService$TestNetworkAgent;->teardown()V
